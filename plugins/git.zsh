...
alias gf='git fetch'
alias glg='log --color --graph --pretty=format:"%Cred%h%Creset -%C(yellow)%d%Creset %s %Cgreen(%cr)%C(bold blue)<%an>%Creset" --abbrev-commit' # Custom log format
alias gm='git merge'
alias gmff="git merge --ff-only"
alias gp='git pull' # Renamed from original
...
alias gt='git tag | sort -V' # Renamed from original
